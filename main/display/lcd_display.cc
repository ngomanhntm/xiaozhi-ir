...
void LcdDisplay::InitializeLcdThemes() {
    ...
    // nezuko theme
    auto nezuko_theme = new LvglTheme("nezuko");
    nezuko_theme->set_background_color(lv_color_hex(0x000000));
    nezuko_theme->set_text_color(lv_color_hex(0xFFFFFF));
    nezuko_theme->set_chat_background_color(lv_color_hex(0x1F1F1F));
    nezuko_theme->set_user_bubble_color(lv_color_hex(0x00FF00));
    nezuko_theme->set_assistant_bubble_color(lv_color_hex(0x222222));
    nezuko_theme->set_system_bubble_color(lv_color_hex(0x000000));
    nezuko_theme->set_system_text_color(lv_color_hex(0xFFFFFF));
    nezuko_theme->set_border_color(lv_color_hex(0xFFFFFF));
    nezuko_theme->set_low_battery_color(lv_color_hex(0xFF0000));
    nezuko_theme->set_text_font(text_font);
    nezuko_theme->set_icon_font(icon_font);
    nezuko_theme->set_large_icon_font(large_icon_font);

    // con_ech theme
    auto con_ech_theme = new LvglTheme("con_ech");
    con_ech_theme->set_background_color(lv_color_hex(0x000000));
    con_ech_theme->set_text_color(lv_color_hex(0xFFFFFF));
    con_ech_theme->set_chat_background_color(lv_color_hex(0x1F1F1F));
    con_ech_theme->set_user_bubble_color(lv_color_hex(0x00FF00));
    con_ech_theme->set_assistant_bubble_color(lv_color_hex(0x222222));
    con_ech_theme->set_system_bubble_color(lv_color_hex(0x000000));
    con_ech_theme->set_system_text_color(lv_color_hex(0xFFFFFF));
    con_ech_theme->set_border_color(lv_color_hex(0xFFFFFF));
    con_ech_theme->set_low_battery_color(lv_color_hex(0xFF0000));
    con_ech_theme->set_text_font(text_font);
    con_ech_theme->set_icon_font(icon_font);
    con_ech_theme->set_large_icon_font(large_icon_font);

    // trex theme
    auto trex_theme = new LvglTheme("trex");
    trex_theme->set_background_color(lv_color_hex(0x000000));
    trex_theme->set_text_color(lv_color_hex(0xFFFFFF));
    trex_theme->set_chat_background_color(lv_color_hex(0x1F1F1F));
    trex_theme->set_user_bubble_color(lv_color_hex(0x00FF00));
    trex_theme->set_assistant_bubble_color(lv_color_hex(0x222222));
    trex_theme->set_system_bubble_color(lv_color_hex(0x000000));
    trex_theme->set_system_text_color(lv_color_hex(0xFFFFFF));
    trex_theme->set_border_color(lv_color_hex(0xFFFFFF));
    trex_theme->set_low_battery_color(lv_color_hex(0xFF0000));
    trex_theme->set_text_font(text_font);
    trex_theme->set_icon_font(icon_font);
    trex_theme->set_large_icon_font(large_icon_font);

    // doremon theme
    auto doremon_theme = new LvglTheme("doremon");
    doremon_theme->set_background_color(lv_color_hex(0x000000));
    doremon_theme->set_text_color(lv_color_hex(0xFFFFFF));
    doremon_theme->set_chat_background_color(lv_color_hex(0x1F1F1F));
    doremon_theme->set_user_bubble_color(lv_color_hex(0x00FF00));
    doremon_theme->set_assistant_bubble_color(lv_color_hex(0x222222));
    doremon_theme->set_system_bubble_color(lv_color_hex(0x000000));
    doremon_theme->set_system_text_color(lv_color_hex(0xFFFFFF));
    doremon_theme->set_border_color(lv_color_hex(0xFFFFFF));
    doremon_theme->set_low_battery_color(lv_color_hex(0xFF0000));
    doremon_theme->set_text_font(text_font);
    doremon_theme->set_icon_font(icon_font);
    doremon_theme->set_large_icon_font(large_icon_font);

    // xe_cuu_hoa theme
    auto xe_cuu_hoa_theme = new LvglTheme("xe_cuu_hoa");
    xe_cuu_hoa_theme->set_background_color(lv_color_hex(0x000000));
    xe_cuu_hoa_theme->set_text_color(lv_color_hex(0xFFFFFF));
    xe_cuu_hoa_theme->set_chat_background_color(lv_color_hex(0x1F1F1F));
    xe_cuu_hoa_theme->set_user_bubble_color(lv_color_hex(0x00FF00));
    xe_cuu_hoa_theme->set_assistant_bubble_color(lv_color_hex(0x222222));
    xe_cuu_hoa_theme->set_system_bubble_color(lv_color_hex(0x000000));
    xe_cuu_hoa_theme->set_system_text_color(lv_color_hex(0xFFFFFF));
    xe_cuu_hoa_theme->set_border_color(lv_color_hex(0xFFFFFF));
    xe_cuu_hoa_theme->set_low_battery_color(lv_color_hex(0xFF0000));
    xe_cuu_hoa_theme->set_text_font(text_font);
    xe_cuu_hoa_theme->set_icon_font(icon_font);
    xe_cuu_hoa_theme->set_large_icon_font(large_icon_font);

    auto& theme_manager = LvglThemeManager::GetInstance();
    theme_manager.RegisterTheme("light", light_theme);
    theme_manager.RegisterTheme("dark", dark_theme);
    theme_manager.RegisterTheme("nezuko", nezuko_theme);
    theme_manager.RegisterTheme("con_ech", con_ech_theme);
    theme_manager.RegisterTheme("trex", trex_theme);
    theme_manager.RegisterTheme("doremon", doremon_theme);
    theme_manager.RegisterTheme("xe_cuu_hoa", xe_cuu_hoa_theme);
}
