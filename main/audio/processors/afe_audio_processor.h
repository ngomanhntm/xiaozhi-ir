...
private:
    ...
    TaskHandle_t audio_communication_task_ = nullptr;
    StaticTask_t* audio_communication_task_buffer_ = nullptr;
    StackType_t* audio_communication_task_stack_ = nullptr;
